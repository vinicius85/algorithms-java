...
public class IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
	 ...
	 * @param key
	 *            change the key associated with index <tt>i</tt> to this key
	 * @throws IndexOutOfBoundsException
	 *             unless 0 &le; <tt>i</tt> &lt; <tt>maxN</tt>
	 * @throws NoSuchElementException
	 *             no key is associated with index <tt>i</tt>
	 ...
	 * @param key
	 *            decrease the key associated with index <tt>i</tt> to this key
	 * @throws IndexOutOfBoundsException
	 *             unless 0 &le; <tt>i</tt> &lt; <tt>maxN</tt>
	 * @throws IllegalArgumentException
	 ...
	 * @param key
	 *            increase the key associated with index <tt>i</tt> to this key
	 * @throws IndexOutOfBoundsException
	 *             unless 0 &le; <tt>i</tt> &lt; <tt>maxN</tt>
	 * @throws IllegalArgumentException
